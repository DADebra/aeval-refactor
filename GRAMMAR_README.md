...
;(assert (= INT_VARS (Int_either_3 _FH_inv_0 _FH_inv_1 _FH_inv_2)))
;(assert (= INT_CONSTS (Int_either_3 -1 0 1)))

(assert (= bterm (Bool_either_2 (= ivar INT_CONSTS) (> ivar INT_CONSTS))))
...
(assert (= bterm (Bool_either_2 (= ivar1 INT_CONSTS) (> ivar2 INT_CONSTS))))
(assert (= ANY_INV (or bterm bterm)))
```
